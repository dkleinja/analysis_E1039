void drawmagflip_sim(const int dmrebin = 4, const int tarvar = 0)
{
  ...
  sprintf(Fname, "./nDST/Analysis_mc_drellyan_%s_M013_S001_spill.root", tardump);
  printf(Fname);
  ...
  Hdmphirat -> Fit(cos1x);
  l0 -> Draw();
  sprintf(Hname, "./images/dimuon_sim_%s_magflip0_over_magflip1.gif", tardump);
  c3 -> SaveAs(Hname);
  ...
  c2 -> cd(3);
  Hchargerat -> Draw();
  sprintf(Hname, "./images/charge_sim_%s_magflip0_over_magflip1.gif", tardump);
  c2 -> SaveAs(Hname);
  ...
  //Hmmmuonphirat -> Fit(cos2x);
  l0 -> Draw();
  sprintf(Hname, "./images/tracklike_sim_%s_magflip0_over_magflip1.gif", tardump);
  c6b -> SaveAs(Hname);
