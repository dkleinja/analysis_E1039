...
for run in range(0, 2822):
	...
	#print rlines[run]
        ...
        hodostatement = "./hodoEfficiency %s ./root_files/R006_momcut10_ycut3_centcut90_trighits1_%s.root > ./logs/momcut10_ycut3_centcut90_trighits1_%s.log 2>&1" % (flines[run], rlines[run], rlines[run]) 
        print hodostatement
