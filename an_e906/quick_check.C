...
void asym2(const int Trig = 1, const int NBins = 1, const int Peak = 0, const int Bkgnd = 0, const int RMIN = 11, const int RMAX = 19, const int Fill = 0, const int Train = 59, const int Final = 1)
{
