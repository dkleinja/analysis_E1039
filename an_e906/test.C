...
void test(const int Trig = 0, const int NBins = 5, const int Roadset = 57)
{
  ...
  for (int a = 0; a < 2; a++)
	...
	for (int j = 0; j < 2; j++){
      ...
      sprintf (Hname, "Yieldmix3_target%d_xf%d", a, k);
  ...
  TH2F *yxfmass  = new TH2F ("yxfmass",  "yxfmass",  100, 0., 10., 100, 0., 1. );
  TH2F *yxfmass3  = new TH2F ("yxfmass3",  "yxfmass3",  100, 0., 10., 100, 0., 1. );
  TH1F *yeta  = new TH1F ("yeta",  "yeta", 300, 2.0, 5.0 );
  TH3F *yxfmasspt  = new TH3F ("yxfmasspt",  "yxfmasspt",  100, 0., 10., 100, 0., 1., 500, 0., 5. );
  TH3F *yxfmasspt3  = new TH3F ("yxfmasspt3",  "yxfmasspt3",  100, 0., 10., 100, 0., 1., 500, 0., 5. );
  TH3F *yxfmasseta  = new TH3F ("yxfmasseta",  "yxfmasseta",  100, 0., 10., 100, 0., 1., 300, 2., 5. );
  TH3F *yxfmasseta3  = new TH3F ("yxfmasseta3",  "yxfmasseta3",  100, 0., 10., 100, 0., 1., 300, 2., 5. );
  ...
  //if(Trig == 2)  sprintf (inName, "./nDST/Analysis_mc_drellyan_LD2_M013_S001.root", Roadset);
  ...
  //for (int i = 0; i < 10000; i++) {
    ...
    if(i%100000 == 0)  cout << "entry, polT " << i << " " << polT << endl;
  ...
  for (int a = 0; a < 2; a++){ // These are the slices in dump/target !!
	...
	for (int j = 0; j < 2; j++){
	  cpa2[j] -> cd();
          sprintf (Hname, "./images_mass_xf/mass2_nbins%d_trig%d_target%d_xf%d_D%d.gif", nbins, Trig, a, k, j);
	  cpa2[j] -> SaveAs(Hname);
	  }
	...
	for (int j = 0; j < 2; j++){
	  cpa[j] -> cd();
	  sprintf (Hname, "./images_mass_xf/masssub_nbins%d_trig%d_target%d_xf%d_B%d_D%d.gif", nbins, Trig, a, k, j);
	  cpa[j] -> SaveAs(Hname);
	}
  ...
  char *outNameText = "./results/asym2_roadset%d_nbins%d.root";
  sprintf (outName, outNameText, Roadset, nbins);
