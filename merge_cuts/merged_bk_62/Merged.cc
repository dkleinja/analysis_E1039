...
int main(int argc, char **argv)
{
  ...
  sprintf(schemaOutput, "cuts1314_merged_roadset62_R004_V005");
  ...
  sprintf(inputFile, "merged_roadset62_R004_V005");
...
*/
  ...
  sprintf(stmt, "INSERT INTO tempSpillList SELECT Spill.spillID FROM %s.Spill "
                ...
                "JOIN %s.Beam AS b2 ON b2.spillID = Spill.spillID AND b2.name = 'F:NM3SEM' "
                ...
                "AND s1.value BETWEEN 100 AND 6000 "
                "AND s2.value BETWEEN 100 AND 6000 "
                "AND s3.value BETWEEN 100 AND 10000 "
                "AND s2.value/s3.value BETWEEN 0.2 AND 1.05 "
                "AND targetPos BETWEEN 1 AND 7 "
                "AND targetPos = Target.value "
                "AND QIEsum BETWEEN 4e10 AND 1e12 "
                "AND inhibit_block_sum BETWEEN 4e9 AND 2e11 "
                "AND trigger_sum_no_inhibit BETWEEN 4e9 AND 1e11 "
                "AND dutyfactor53MHz BETWEEN 10 AND 60 "
                "AND Spill.spillID != 0;",
