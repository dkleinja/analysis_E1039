...
std::string hodoTrigs[nTrigs] = {"1H1Y", "1H2Y", "1H3Y", "1H4Y", "2H12Y", "2H13Y", "2H14Y", "2H23Y", "2H24Y", "2H34Y", "3H123Y", "3H124Y", "3H234Y", "NIM1", "NIM2", "NIM3"};
...
//string hodoNames[nHodos] ={"H1B"  ,"H1T"  , "H2B"  , "H2T"  , "H3B"  , "H3T"  , "H4B"  , "H4T"  ,"H1L " ,"H1R"  , "H2L" ,  "H2R"  ,"H4Y1L","H4Y1R","H4Y2L", "H4Y2R"};
Float_t X0_hodoPos[nHodos] = {-81.  , -81.  , -101.62, -101.62, -113.76, -113.76, -152.26, -152.26,   0.  , -78.74,    0. ,  -132.  ,    0. , -152.4,    0. , -152.4};
Float_t XF_hodoPos[nHodos] = { 81.  ,  81.  ,  101.62,  101.62,  113.76,  113.76,  152.26,  152.26,  78.74,   0.  ,  132. ,     0.  ,  152.4,    0. ,  152.4,    0. };

Float_t Y0_hodoPos[nHodos] = {-69.85,   0.  , -152.  ,    0.  , -167.64,    0.  , -182.88,    0.  , -70.06, -70.06, -120.64, -120.64, -182.9, -182.9, -182.9, -182.9};   
Float_t YF_hodoPos[nHodos] = {  0.  ,  69.85,    0.  ,  152.  ,    0.  ,  167.64,    0.  ,  182.88,  70.06,  70.06,  120.64,  120.64,  182.9,  182.9,  182.9,  182.9}; 
