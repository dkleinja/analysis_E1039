void drawDeltaAn(const int tarpos =350, const int magpos = 150, const int type = 0)
{
  ...
  sprintf(Fname, "./root_files/exclusion_dimuon_target_tarpos%d_magpos150_magval0.root", tarpos, magpos);  
  TFile * inFile_0 = new TFile(Fname);
  sprintf(Fname, "./root_files/exclusion_dimuon_target_tarpos%d_magpos%d_magvalm1.root", tarpos, magpos);  
  ...
  sprintf(Fname, "./root_files/exclusion_dimuon_target_tarpos%d_magpos%d_magvalp1.root", tarpos, magpos);  
  sprintf(Fname, "./root_files/exclusion_dimuon_target_tarpos300_magpos150_magval0.root", tarpos, magpos);  
  ...
  if(type == 0){
    TH1F *HxT_e906 = (TH1F*) inFile_e906 -> Get("HxTproposal");
    TH1F *HxT_0 = (TH1F*) inFile_0 -> Get("HxTproposal");
    TH1F *HxT_m1 = (TH1F*) inFile_m1 -> Get("HxTproposal");
    TH1F *HxT_m2 = (TH1F*) inFile_m2 -> Get("HxTproposal");
    TH1F *HxT_p1 = (TH1F*) inFile_p1 -> Get("HxTproposal");
    TH1F *HxT_p2 = (TH1F*) inFile_p2 -> Get("HxTproposal");
  }
  if(type == 1){
  ...
  */
  ...
  //HxT_0 -> SetTitle("Ratio of Rates, E1039/E906");
  HxT_0 -> SetTitle("Ratio of Rates, -350cm/-300cm");
  HxT_p1 -> SetTitle("Ratio of Rates, -300cm/-350cm");
  ...
  legend -> AddEntry(HxT_0,"0 Tesla [-350 cm]");
  legend -> AddEntry(HxT_m1,"-1 Tesla [-350 cm]");
  //legend -> AddEntry(HxT_m2,"-2 Tesla");
  //legend -> AddEntry(HxT_p1,"+1 Tesla");
  legend -> AddEntry(HxT_p1,"0 Tesla [-300 cm]");
  ...
  for(int i = 0; i < 5; i++){
    cout << "HxT_0 rate " << HxT_0->GetBinContent(i)<< endl;
  }
  cout << endl;
  for(int i = 0; i < 5; i++){
    cout << "HxT_m1 rate " << HxT_m1->GetBinContent(i)<< endl;
  }
  cout << endl;
  for(int i = 0; i < 5; i++){
    cout << "HxT_p1 rate " << HxT_p1->GetBinContent(i)<< endl;
  }
