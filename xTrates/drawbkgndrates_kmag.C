void drawbkgndrates_kmag(const int tarpos = 350, const int magpos = 150, const int trig = 0)
{
...
gStyle -> SetOptStat(1);
  ...
  //sprintf(Fname, "./root_files/bkgndH1_gun10M_tarpos%d_magpos%d_magvalm1_test2.root", tarpos, magpos);  
  sprintf(Fname, "./root_files/bkgndH1_e906db1_gun40M_tarpos350_kmagm1.root", tarpos, magpos);  
  TFile * inFile2_m1 = new TFile(Fname);
  sprintf(Fname, "./root_files/bkgndH1_gun_tarpos%d_magpos%d_magvalm2.root", tarpos, magpos);  
  sprintf(Fname, "./root_files/bkgndH1_gun10M_tarpos350_kmagm1.root", tarpos, magpos);  
  ...
  TH1F *H1hits0 = new TH1F("H1hits0","Ratio of  kmagp1/e906",24,1,24);
  H1hits0 -> SetLineColor(1);
  TH1F *H1hits1 = new TH1F("H1hits1","Ratio of kmagm1/e906 ",24,1,24);
  H1hits1 -> SetLineColor(2);
  
  TH1F *H2hits0 = new TH1F("H2hits0","Ratio of  kmagp1/e906",8,1,16);
  H2hits0 -> SetLineColor(1);
  TH1F *H2hits1 = new TH1F("H2hits1","Ratio of kmagm1/e906 ",8,1,16);
  H2hits1 -> SetLineColor(2);
  
  TH1F *H3hits0 = new TH1F("H3hits0","Ratio of  kmagp1/e906",8,1,16);
  H3hits0 -> SetLineColor(1);
  TH1F *H3hits1 = new TH1F("H3hits1","Ratio of kmagm1/e906 ",8,1,16);
  ...
  */
  ...
  sprintf(Hname, "./images_xTrates/H1hits_kmagm1_target_tarpos%d_magpos%d_trig%d.gif", tarpos, magpos,trig);
  c1 -> SaveAs(Hname);
  ...
  c2 -> cd();
  sprintf(Hname, "./images_xTrates/ratioH1hits_kmagm1_target_tarpos%d_magpos%d_trig%d.gif", tarpos, magpos,trig);
  c2 -> SaveAs(Hname);
  ...
  sprintf(Hname, "./images_xTrates/H2hits_kmagm1_target_tarpos%d_magpos%d_trig%d.gif", tarpos, magpos,trig);
  c1 -> SaveAs(Hname);
  ...
  c2 -> cd();
  sprintf(Hname, "./images_xTrates/ratioH2hits_kmagm1_target_tarpos%d_magpos%d_trig%d.gif", tarpos, magpos,trig);
  c2 -> SaveAs(Hname);
  ...
  sprintf(Hname, "./images_xTrates/H3hits_kmagm1_kmagm1_target_tarpos%d_magpos%d_trig%d.gif", tarpos, magpos,trig);
  c1 -> SaveAs(Hname);
  ...
  c2 -> cd();
  sprintf(Hname, "./images_xTrates/ratioH3hits_kmagm1_target_tarpos%d_magpos%d_trig%d.gif", tarpos, magpos,trig);
  c2 -> SaveAs(Hname);
