void gettapered2(const char *schema, const float maglength = 200, const float magpos = 150, const float magval = 0)
{
   ...
   Hdr2 -> SetLineColor(2);
   TH2F *Hdxdy = new TH2F("Hdxdy", "Dimuon #Deltay vs #Deltax at end of magnet [z=-50 cm]", 50, -50, 50, 50, -50, 50);
