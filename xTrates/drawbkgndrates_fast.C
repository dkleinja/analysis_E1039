void drawbkgndrates_fast(const int tarpos = 350, const int magpos = 150, const int trig = 0)
{
  ...
  sprintf(Fname, "./root_files/bkgndH1_guncut40M_tarpos%d_magpos%d_magval0.root", tarpos, magpos);  
  ...
  TH1F *H1hits0 = new TH1F("H1hits0","Ratio of  gun/e906",24,1,24);
  H1hits0 -> SetLineColor(1);
  TH1F *H1hits1 = new TH1F("H1hits1","Ratio of guncut/e906 ",24,1,24);
  H1hits1 -> SetLineColor(2);
  TH1F *H1hits2 = new TH1F("H1hits2","Ratio of gun/guncut ",24,1,24);
  H1hits2 -> SetLineColor(4);
  ...
  TH1F *H2hits2 = new TH1F("H2hits2","Ratio of gun/guncut ",8,1,16);
  H2hits2 -> SetLineColor(4);
  ...
  */
  ...
  legend -> AddEntry(H1hits_0,"gun");
  legend -> AddEntry(H1hits_m1,"guncut");
